    ...
    for filename in os.listdir(input_dir):
        if filename.endswith(".json"):
            ...
            try:
                ...
                archetypes = data.pop('archetypes',)  # Remove 'subraces' from parent
                ...
                for archetype in archetypes:
                    ...
                    archetype_file_path = os.path.join(parent_dir, f"{archetype_name}.json")
                    with open(archetype_file_path, 'w') as outfile:
                        json.dump(archetype, outfile, indent=4)  # Save subrace
...
# --- Example Usage ---
input_directory = "/workspaces/capstoneproject-e5-studios/app/src/main/assets/dndclasses"  # Replace with the path to your directory
